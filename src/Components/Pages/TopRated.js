...
const TopRated = () => {
  ...
  const fetchMovies = async () => {
    try {
      ...
      if (searchText) {
        ...
        url = `https://api.themoviedb.org/3/movie/top_rated?api_key=${process.env.REACT_APP_API_KEY}&page=${page}&with_genres=${genreforURL}`;
      }
  ...
  return (
    <div style={{ paddingTop: "2em", backgroundColor: "black" }}>
      <span className="pageTitle">TopRated Movies</span>
      {/* Search input */}
